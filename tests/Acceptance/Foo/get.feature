Feature:
    ...
    Scenario: It can retrieve a Foo
        ...
        When A GET request is sent to "/foo/7f590fc8-1298-4fb7-927e-a38ae50bc705"
        ...
        And the response should be a documented and validated with OpenApi schema GET "/foo/7f590fc8-1298-4fb7-927e-a38ae50bc705"

    Scenario: It can't retrieve a Foo with invalid ID
        When A GET request is sent to "/foo/111111"
        Then the response header "Content-Type" should be equal to "application/json"
        And the JSON response should be equal to:
        """
        {
        ...
        And the response should be a documented and validated with OpenApi schema GET "/foo/111111"
    ...
    Scenario: It can't retrieve a missing Foo
        ...
        And the response should be a documented and validated with OpenApi schema GET "/foo/0b14e425-5f80-4c29-a3ab-49f5f15ca57d"
