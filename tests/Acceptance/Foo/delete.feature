Feature:
  ...
  Scenario: It can delete a Foo
    ...
    When A DELETE request is sent to "/foo/7f590fc8-1298-4fb7-927e-a38ae50bc705"
    Then the response should be empty
    And the response code should be 204
    And the response should be a documented and validated with OpenApi schema DELETE "/foo/7f590fc8-1298-4fb7-927e-a38ae50bc705"
  ...
  Scenario: It can't delete a Foo with invalid ID
    When A DELETE request is sent to "/foo/111111"
    ...
    And the response should be a documented and validated with OpenApi schema DELETE "/foo/111111"

  Scenario: It can't delete a missing Foo
    When A GET request is sent to "/foo/0b14e425-5f80-4c29-a3ab-49f5f15ca57d"
    Then the response header "Content-Type" should be equal to "application/json"
    And the JSON response should be equal to:
        """
        {
    ...
    And the response should be a documented and validated with OpenApi schema DELETE "/foo/0b14e425-5f80-4c29-a3ab-49f5f15ca57d"
